...
//        clientDTO = clientMapper.convertToDTO(clientTemplate);
...
//
//        ClientDTO clientResultDTO = clientService.getClientById(3l);
//        verify(clientRepository).findById(anyLong());
//        compareClient(clientMapper.convertToDTO(clientTemplate, clientResultDTO);
//    }
//
//    @Test
