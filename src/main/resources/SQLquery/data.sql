...
VALUES (   'DEPOSIT', 100000, 'Перевод клиентом 9 со счета number11  клиенту 8 на счет number11', 'RUB', '2023-11-13');



INSERT INTO public.agreement( interest_rate, status, sum, created_at, updated_at, product_id, account_id)
VALUES (   17.25, 'ACTIV', 100000, 17.25, '1998-07-07', null,1, 1);
