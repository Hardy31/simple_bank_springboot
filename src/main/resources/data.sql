...
VALUES ('Ivan', 'Pohomov', 'StariyOskol', 'VIP', 'Ivan@mail.ru', '(123)123-45-67', 'ACTIVE', '1998-07-07', null, 1),
       ('Artem', 'Nesterenko', 'Gubkin', 'VIP', 'Artem@mail.ru', '(123)123-45-68', 'ACTIVE', '1998-07-08', '2023-11-10', 2),
       ('Semen', 'Shevtsov', 'Gubkin', 'VIP', 'Semen@list.ru', '(123)123-45-69', 'ACTIVE', '1998-07-09', '2023-10-27', 1),
       ('Arhip', 'Kalashnikov', 'Gubkin', 'VIP', 'Arhip@gmail.comu', '(123)123-45-70', 'PENDING', '1998-07-10', null, 3),
       ('Bogdan', 'Noshevkin', 'Belgorod', 'VIP', 'Bogdan@mail.ru', '(123)123-45-71', 'BLACKLISTED', '1998-07-11', '2023-10-27', 5),
       ('Stepan', 'Bogdanov', 'Gubkin', 'VIP', 'Stepan@gmail.com', '(123)123-45-72', 'BLACKLISTED', '1998-07-12', null, 2),
       ('Egor', 'Churikov', 'Belgorod', 'VIP', 'Egor@mail.ru', '(123)123-45-73', 'INACTIVE', '1998-07-13', '2023-10-27', 2),
       ('Vlalimir', 'Putin', 'Moskva', 'VIP', 'Vlalimir@mail.ru', '(123)123-45-74', 'ACTIVE', '1998-07-14', '2023-10-27', 1),
       ('Sergey', 'Voronov', 'Belgorod', 'VIP', 'Sergey@mail.ru', '(123)123-45-75', 'PENDING', '1998-07-15', null, 1);
